...
////////
    ...
    //post , get // start
    useEffect(() => {
        axios("http://141.8.195.239/api/cash-session/info/", {
            headers: {
    ...
    const Pay = (e) => {
        e.preventDefault()
        {
            !pay ? axios.post("http://141.8.195.239/api/operation/create/", {
                    "products":
                        cart.map((el) => {
    ...
    const submitStart = (e) => {
        e.preventDefault()
        axios.post("http://141.8.195.239/api/cash-session/start/", {
    ...
    function submitEnd(e) {
        e.preventDefault()
        axios.patch("http://141.8.195.239/api/cash-session/finish/", {
                money_end: state.end
            },
            {
                headers: {
